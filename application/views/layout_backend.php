...
<head>
    ...
    <script src="<?=base_url()?>assets/js/angular/angular-cookies.min.js.map"></script>
...
<body ng-app="sfApp" ng-controller="topCtrl" id="topCtrl">
    <div id="wrapper">
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="">
                        <?php if (is_allow('M_USERS')): ?>
                        <a href="comp01"><i class="fa fa-user"></i> <span class="nav-label">Data Inventory</span> 
                        <?php endif;?>
                    </li>
                    <li class="">
        ...
        <div class="footer" style="position: fixed;">
            ...
            <div>
                <strong>Copyright</strong> <a href="youtube.com/peternakkode" target="_blank">IT Operation</a> © 2023
            </div>
        </div>
    </div>
    <script>
